...
# Seeds
PEPPERS_SEEDS = 'button[data-name="Carrot Seeds"]'
CARROTS_SEEDS = 'button[data-name="Carrot Seeds"]'
PEA_SEEDS = 'button[data-name="Carrot Seeds"]'
CUCUMBER_SEEDS = 'button[data-name="Carrot Seeds"]'
EGGPLANT_SEEDS = 'button[data-name="Carrot Seeds"]'
RADISH_SEEDS = 'button[data-name="Carrot Seeds"]'
ONION_SEEDS = 'button[data-name="Carrot Seeds"]'
HOPS_SEEDS = 'button[data-name="Carrot Seeds"]'
POTATO_SEEDS = 'button[data-name="Carrot Seeds"]'
TOMATO_SEEDS = 'button[data-name="Carrot Seeds"]'
LEEK_SEEDS = 'button[data-name="Carrot Seeds"]'
WATERMELON_SEEDS = 'button[data-name="Carrot Seeds"]'
CORN_SEEDS = 'button[data-name="Carrot Seeds"]'
CABBAGE_SEEDS = 'button[data-name="Carrot Seeds"]'
PINE_SEEDS = 'button[data-name="Carrot Seeds"]'
